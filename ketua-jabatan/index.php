...
$totalPermohonan = $controller->getCount($conn, 'permohonan');
$totalPermohonanDalamPengesahan = $controller->getCount($conn, 'permohonan', 'WHERE permohonan_status_id = 1 OR pengesahan_warden_id = 1');
$totalPermohonanBerjaya = $controller->getCount($conn, 'permohonan', 'WHERE permohonan_status_id = 2 OR pengesahan_warden_id = 2');
$totalPermohonanDitolak = $controller->getCount($conn, 'permohonan', 'WHERE permohonan_status_id = 3 AND pengesahan_warden_id = 3');
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box tilebox-one">
                                ...
                                <h3 class="my-3" data-plugin="counterup">
                                    <?= number_format($totalPermohonan['total'], 0) ?></h3>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box tilebox-one">
                                ...
                                <h6 class="text-muted text-uppercase mt-0">Permohonan Dalam Pengesahan</h6>
                                <h3 class="my-3"><span
                                        data-plugin="counterup"><?= number_format($totalPermohonanDalamPengesahan['total'], 0) ?></span>
                                </h3>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box tilebox-one">
                                ...
                                <h3 class="my-3"><span
                                        data-plugin="counterup"><?= number_format($totalPermohonanBerjaya['total'], 0) ?></span>
                                </h3>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <div class="card-box tilebox-one">
                                ...
                                <h3 class="my-3" data-plugin="counterup">
                                    <?= number_format($totalPermohonanDitolak['total'], 0) ?></h3>
