...
$permohonan = $controller->getSingleData($conn, 'permohonan', ' permohonan.id = ' . $_GET['id'], ', pelajar.*, permohonan_status.status as status, permohonan_status.class as class, pengesahan_warden.pengesahan as pengesahan, pengesahan_warden.class as pengesahanClass, permohonan.id as permohonanId', 
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group p-3">
                                        ...
                                        <?php 
                                            if(!$isWeekend){ ?>
                                                <a class="btn btn-success btn-sm" href="../controller/controller.php?mod=permohonanditerima&id=<?= $permohonan['permohonanId'] ?>" >Diterima</a>
                                                <a class="btn btn-danger btn-sm" href="../controller/controller.php?mod=permohonanditolak&id=<?= $permohonan['permohonanId'] ?>" >Ditolak</a>
                                        <?php } ?>
