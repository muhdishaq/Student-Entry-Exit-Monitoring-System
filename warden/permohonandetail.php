                                    ...
                                    <form action="../controller/controller.php?mod=kemaskinipelajar" method="post">
                                            ...
                                            <table class="table table-bordered table-nowrap mb-0">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><span class=""><?= $permohonan['pengesahan_oleh'] ?></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <div class="form-group p-3">
                                            ...
                                            <a class="btn btn-success btn-sm"
                                                href="../controller/controller.php?mod=wardenpermohonanditerima&id=<?= $permohonan['permohonanId'] ?>">Diterima</a>
                                            <a class="btn btn-danger btn-sm"
                                                href="../controller/controller.php?mod=wardenpermohonanditolak&id=<?= $permohonan['permohonanId'] ?>">Ditolak</a>
